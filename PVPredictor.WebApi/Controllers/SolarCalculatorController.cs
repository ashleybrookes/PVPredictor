...
namespace SolarCalculator.Controllers
{
    ...
    public class SolarCalculatorController : ControllerBase
    {
        ...
        public IActionResult Get_IActionResult(string city)
        {
            ...
            listSolarData.Add(new SolarCalculator.LocationSolarData { dt = DateTime.Now, latitude = (double)cityLatitudeCoordinates[city], longitude = (double)cityLongitudeCoordinates[city] , solarMaximum = 1, solarPercentage = 1, solarPowerWatts = 1 });
